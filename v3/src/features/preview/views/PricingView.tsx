...
import viewStyles from './PricingView.module.css'
import landingStyles from '../templates/LandingTemplate/LandingTemplate.module.css'
...
export function PricingView({ onBack }: PricingViewProps) {
  ...
  return (
    <div className={viewStyles.view}>
      <button className={viewStyles.backBtn} onClick={onBack}>← Back</button>
      ...
      <div className={landingStyles.pricingGrid}>
        ...
        <div className={landingStyles.pricingCard}>
          ...
          <button
            className={landingStyles.pricingCta}
        ...
        <div className={`${landingStyles.pricingCard} ${landingStyles.pricingCardHighlight}`}>
          <div className={landingStyles.pricingLabelRow}>
            ...
            {EARLY_BIRD_ACTIVE && (
              <span className={landingStyles.earlyBirdBadge}>Early Bird</span>
            )}
          </div>
          ...
          {isSignedIn && isPaid && (
            <button
              className={`${landingStyles.pricingCta} ${landingStyles.pricingCtaDisabled}`}
              disabled
            >
              You&apos;re all set ✓
            </button>
      ...
      <div className={landingStyles.coffeeRow}>
        ...
        <button
          className={landingStyles.coffeeBtn}
